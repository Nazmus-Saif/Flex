...
<span class="cross-mark"><i class="fa-solid fa-xmark fa-xs"></i></span> <!--this is for the cross sign of the side bar -->
<div class="black"></div> <!--for darkar the rest of the part of the screen when side bar is open -->
<!-- side bar ends -->
<!-- Genres show when hovers the genre button on header -->
