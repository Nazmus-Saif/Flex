...
<body>
    <div class="full-body">
        ...
        <div class="login-container">
            <div class="login-box">
                <form action="" method="POST" class="login-box-form">
                    <h2>Confirm Verification Code</h2>
                    <div>
                        <input type="verification_code" name="verification_code" id="verification_code" autoComplete="true" placeholder="Enter 5 digit code" value="" required />
                    </div>
                    <button type="submit" class="btn btn-primary" name="login_form">Proced</button>
